...
<div class="container">
  ...
  <div class="content">
    ...
    <?php 
      ...
      $blog = new WP_Query( array( 'post_type' => 'omura', 'posts_per_page' =>  1, 'order' => 'DESC'));
  ...
  <?php 
    ...
    $blogs = new WP_Query( array( 'post_type' => 'omura', 'posts_per_page' =>  3, /*'post__not_in' => array($exclude_post),*/ 'order' => 'DESC'));

    if($blogs) :

  ?>

    <h3 class="title -inner-session">Memórias</h3>
